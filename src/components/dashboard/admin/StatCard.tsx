    ...
    return (
        <div className="bg-background rounded-2xl p-6 flex flex-col gap-4 min-w-[220px] flex-1 shadow-sm transition-transform duration-200 hover:scale-[1.02]">
            ...
            {href && (
                <Link
                    href={href}
                    className="text-sm font-medium bg-background-light text-basic rounded-lg px-4 py-2 text-center transition-all duration-200 hover:bg-primary mt-auto shadow-sm hover:shadow-md hover:text-white/90 "
                >
                    {linkLabel ?? "View All"}
                </Link>
            )}
