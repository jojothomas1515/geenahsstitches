            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-10">
                    <div>
                        ...
                        <p className="text-muted">Organize products into curated groups for the store.</p>
                    </div>
                    <button
                ...
                {isLoading ? (
                    ...
                    <CollectionTable 
                        ...
                        baseUrl="/staff/dashboard/collections"
                    />
                ) : (
                    <div className="flex flex-col items-center justify-center py-20 bg-background rounded-2xl border border-background-dark text-center px-6">
                        ...
                        <p className="text-muted max-w-md mb-8">
                            Collections help group products for special offers, seasons, or categories.
                        </p>
                        <button
                            onClick={handleCreate}
